...
def iniciar():
    ...
    try:
        ...
        #pyautogui.click(1200,317,duration=0.5)
        
        # Processa os itens conferindo se tem os lotes informados
        pyautogui.click(1197,342,duration=0.5) 
        sleep(0.5)
        ...
        pyautogui.click(64,144,duration=0.2) 
        sleep(1.3)
        
        # Transportadora
        pyautogui.doubleClick(225,87,duration=0.2) 
        ...
        if redespacho == '0' or redespacho == '':
            ...
            tem_redespacho = True
            pyautogui.click(220,163,duration=0.2)
            pyautogui.write(redespacho)

        # Quantidade de volumes
        pyautogui.click(190,211,duration=0.2) 
        pyautogui.write(volume)

        # Tipo de volume
        pyautogui.click(229,211,duration=0.2) 
        pyautogui.write(especie)

        # Preenche as frases
        pyautogui.doubleClick(173,266,duration=0.2) 
        for frase in frases:        
        ...
        # Processar
        pyautogui.click(1324,38,duration=0.2) 
        ...
        # Fechar NF
        pyautogui.click(1246,61,duration=0.3)
        sleep(0.5)
        
        # Variáveis usadas no looping
        fechar = True
        sim = True
        continuar = True
        certificado = True
        ...
        while fechar: 
            ...
            try:
                clica_imprimir = pyautogui.locateOnScreen('img/imprimir.png', minSearchTime=1, region=(418,0,656,63))
            ...
            # Verifica se pode sair do looping
            if sim == False and continuar == False and certificado == False:
                fechar = False

        # clica no Ok para continuar
        clica_ok = pyautogui.locateOnScreen('img/ok-1.png', minSearchTime=0.3, region=(1193, 0, 1361, 271))
